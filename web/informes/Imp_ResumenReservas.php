...
$conectate=pg_connect("host=www.smarthub.design port=5432 dbname='Aguara' user='postgres' password='2016aws.Postgres.ubuntu'")or die ('Error al conectar a la base de datos');
