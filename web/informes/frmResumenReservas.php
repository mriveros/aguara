...
<head>
    ...
    <meta name="author" content="">
     ...
     <title>Aguara-Resumen Reservas</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Informes - <small>Aguara</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="Imp_ResumenReservas.php" method="post" role="form">
