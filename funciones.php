        ...
        {
             return $dbconn = $conectate=pg_connect("host='localhost' port=5432 dbname='aguara' user='postgres' password='Riveros200587!'")or die ('Error al conectar a la base de datos');
        } 
